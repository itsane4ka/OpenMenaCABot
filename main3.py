...
bot = telebot.TeleBot('5714104662:AAF4G86rsEz3i4u1VCvW857ufMcLst1Ftnw')
...
def handle_contact(message):
    ...
    if chat_id in user_state_ca and fields_for_ca[user_state_ca[chat_id]] == 'Телефон для связи':
        ...
        user_data_ca_for_post[form_entry[user_state_ca[chat_id]]] = message.contact.phone_number
        ...
        user_data_mena_for_post[form_entry[user_state_mena[chat_id]]] = message.contact.phone_number
...
def handle_button_click(message):
    ...
    if text == "Подписаться":
        ...
        try:
            member = bot.get_chat_member(channel_id[0], chat_id)
    ...
    elif text == "Kанал OpenCalifornia":
        bot.send_message(chat_id, channel_open_california_link)
...
def send_message_4_ticket(chat_id):
    ...
    button2 = types.KeyboardButton(text="Стать партнером")
...
def send_message_6_ticket(chat_id):
    ...
    button3 = types.KeyboardButton(text="На главную")
